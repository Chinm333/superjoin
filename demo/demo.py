"""
Demo Interface for Semantic Spreadsheet Search Engine

This module provides a simple demo interface to showcase the semantic search capabilities.
"""
...
def run_demo():
    ...
    print(f"\n5. Interactive mode:")
    print("You can now try your own queries. Type 'quit' to exit.")
